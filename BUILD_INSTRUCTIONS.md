...
- **AGP alignment:** `eas-build-post-install` and prebuild scripts align Android Gradle Plugin to React Native’s default (8.11.0) so the app and native modules use the same AGP and variant matching succeeds.
